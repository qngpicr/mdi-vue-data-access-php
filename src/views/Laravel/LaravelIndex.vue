<template>
  <div class="container mt-4">
    <h2 style="margin-top:20px">RouteInfoController(Laravel)</h2>
...
onMounted(async () => {
  const res = await fetch('https://localhost:9203/routes') // Laravel REST API 호출
